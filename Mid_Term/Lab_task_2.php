...
Phone Number:
<input type="number" id="pnumber" class="Amit" placeholder="Enter your phone number"><br><br>
...
<button id="B1" class="btn" onclick="reg()">Register</button> <br><br> 
<div id="D1" style="margin: 10px 0px"></div>
<div id="D2" style="margin: 10px 0px"></div>
</form>
<form class="xform" onsubmit="return false">
...
<button id="B3" style=" margin: 10px 0px" onclick="RemoveActivity()">Delete</button>
</form>
